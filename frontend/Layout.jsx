  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2.5 px-5 py-6 border-b border-gray-100 dark:border-gray-800">
        <div className="w-9 h-9 bg-teal-600 rounded-xl flex items-center justify-center shadow-lg shadow-teal-200/50 dark:shadow-teal-900/50">
          <Activity className="w-5 h-5 text-white" />
        </div>
        <div>
          <span className="font-bold text-gray-900 dark:text-white text-lg leading-none">CuraAI</span>
          <p className="text-xs text-gray-400 mt-0.5">AI Health Advisor</p>
        </div>
      </div>
